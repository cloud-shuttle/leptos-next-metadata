...
test.describe('Cross-Browser Metadata Compatibility', () => {
  ...
  test.describe('Mobile Chrome', () => {
    test('should generate metadata correctly on mobile Chrome', async ({ page }) => {
      // Set mobile viewport
  ...
  test.describe('Mobile Safari', () => {
    test('should generate metadata correctly on mobile Safari', async ({ page }) => {
      // Set mobile viewport
      await page.setViewportSize({ width: 375, height: 667 });
  ...
  test.describe('Cross-Browser Consistency', () => {
    test('should generate identical metadata across all browsers', async ({ page }) => {
    ...
    test('should have consistent OpenGraph metadata across browsers', async ({ page }) => {
    ...
    test('should have consistent Twitter metadata across browsers', async ({ page }) => {
  ...
  test.describe('Browser-Specific Features', () => {
    test('should handle browser-specific meta tag rendering', async ({ page }) => {
    ...
    test('should handle JSON-LD consistently across browsers', async ({ page }) => {
