...
test.describe('Real Metadata Macro Validation', () => {
  ...
  test.describe('HTML Structure Validation', () => {
    ...
    test('should have proper page content', async ({ page }) => {
      ...
      expect(paragraphs).toContain('This is a test page for metadata macro testing.');
      expect(paragraphs).toContain('Check the page source to see the generated metadata tags.');
    });
  });
