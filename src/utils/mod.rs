...
mod tests {
    ...
    mod common {
        ...
        fn test_truncate_string() {
            ...
            assert_eq!(
                crate::utils::common::truncate_string(long, 20),
                "This is a very lo..."
            );
        ...
        fn test_clean_string() {
            ...
            assert_eq!(
                crate::utils::common::clean_string(single_line),
                "Single line"
            );
        }
    }
    ...
    mod seo {
        ...
        fn test_title_to_slug() {
            assert_eq!(
                crate::utils::seo::title_to_slug("Hello World"),
                "hello-world"
            );
            assert_eq!(
                crate::utils::seo::title_to_slug("Hello, World!"),
            ...
            assert_eq!(
                crate::utils::seo::title_to_slug("Multiple   Spaces"),
                "multiple-spaces"
            );
            assert_eq!(
                crate::utils::seo::title_to_slug("Special@#$%^&*()Chars"),
                "specialchars"
            );
        ...
        fn test_contains_spam_words() {
            assert!(crate::utils::seo::contains_spam_words(
                "Buy now and get the best price!"
            ));
            assert!(crate::utils::seo::contains_spam_words(
    ...
    mod cache {
        ...
        fn test_generate_cache_key() {
            let metadata = Metadata::with_title("Test Title").description("Test Description");
        ...
        fn test_generate_cache_key_no_title() {
            let metadata = Metadata::default().description("Test Description");
